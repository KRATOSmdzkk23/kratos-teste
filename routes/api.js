...
const randomimg = require("random-image-api")
...
const listkey = ["kratos", "manogay"];
apikeylist = ['kratos', 'pinguim', 'tobi'];
...
router.get('/anime/lolis', (req, res) => {
...
router.get('/anime/buscanime', async (req, res, next) => {
        var Apikey = req.query.apikey,
	    search = req.query.search
